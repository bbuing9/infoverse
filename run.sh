...
#CUDA_VISIBLE_DEVICES=$GPU python construct_infoverse.py --train_type xxxx_base --seed_list "1234 2345" --batch_size $BATCH_SIZE --epochs $EPOCHS --dataset $DATASET --seed 1234 --backbone $BACKBONE
