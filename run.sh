...
#CUDA_VISIBLE_DEVICES=$GPU python construct_infoverse.py --train_type xxxx_base --seed_list $SEED --batch_size $BATCH_SIZE --epochs $EPOCHS --dataset $DATASET --seed 1234 --backbone $BACKBONE