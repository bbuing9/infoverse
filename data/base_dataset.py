...
class ANLIDataset(BaseDataset):
    def __init__(self, data_name, n_class, tokenizer, data_ratio=1.0, seed=0):
        super(ANLIDataset, self).__init__(data_name, n_class, tokenizer, data_ratio, seed)
...
class WinoDataset(BaseDataset):
    def __init__(self, tokenizer, data_ratio=1.0, seed=0):
        super(WinoDataset, self).__init__('wino', 2, tokenizer, data_ratio, seed)
...
class IMPDataset(BaseDataset):
    ...
    '''
    def __init__(self, tokenizer, data_ratio=1.0, seed=0):
        super(IMPDataset, self).__init__('imp', 5, tokenizer, data_ratio, seed)
